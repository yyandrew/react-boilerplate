    ...
    <div className="App">
      ...
      {state.showLogin && (
        <div className="App-dialog">
          ...
          />
          <button
            onClick={() => dispatch({ type: 'LOGIN', payload: password })}
          >
            Login
          </button>
          <button onClick={() => dispatch({ type: 'CANCEL_DELETION' })}>
            Cancel
          </button>
      ...
      {state.showConfirmation && (
        <div className="App-dialog">
          ...
          <button onClick={() => dispatch({ type: 'CONFIRM_DELETION' })}>
            Yes
          </button>
          <button onClick={() => dispatch({ type: 'CANCEL_DELETION' })}>
            No
      ...
      {state.showResult && (
        <div className="App-dialog">
          ...
          <button onClick={() => dispatch({ type: 'FINISH' })}>Done</button>
        </div>
      )}
    </div>
  )
